...
// TECH_ICONS and helper functions remain - PROJECTS_DATA is now in Supabase

export const TECH_ICONS: {
  [key: string]: (props: React.SVGProps<SVGSVGElement>) => React.ReactElement;
} = {
  nextjs: (props) => (
  ...
  javascript: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path
        ...
        d="M9.04,15.5H7.5V9.25h1.54V15.5z M14.6,12.64c0,1.44-0.81,2.25-2.03,2.25c-0.81,0-1.44-0.41-1.67-0.99h-0.05l-0.09,0.84H9.2V9.25h1.54v0.84h0.05c0.23-0.58,0.86-0.99,1.67-0.99C13.79,9.1,14.6,9.91,14.6,11.35V12.64z M13.06,12.5c0-0.72-0.36-1.22-0.95-1.22s-0.95,0.5,0.95-1.22v1.26c0,0.72,0.36,1.22,0.95,1.22s0.95-0.5,0.95-1.22V12.5z"
      />
    </svg>
  ),
  nodejs: (props) => (
  ...
  typescript: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path
        fill="hsl(var(--background))"
        d="M14.5 9.5v1.25h-2v6.75h-1.5v-6.75h-2V9.5h5.5z"
      />
    </svg>
  ),
  shadcn: (props) => (
...
export const getTechColor = (tech: string): string => {
  ...
  const colorMap: { [key: string]: string } = {
    ...
    python:
      "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 border-blue-300 dark:border-blue-400/30",
    javascript:
      "bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-400/30",
    typescript:
      "bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-300/30",
    html: "bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 border-red-300 dark:border-red-400/30",
    html5:
      "bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 border-red-300 dark:border-red-400/30",
    ...
    nextjs:
      "bg-gray-100 dark:bg-gray-800/20 text-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-300/30",
    nodejs:
      "bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 border-green-300 dark:border-green-400/30",
    fastapi:
      "bg-teal-100 dark:bg-teal-500/20 text-teal-700 dark:text-teal-400 border-teal-300 dark:border-teal-400/30",
    tailwindcss:
    ...
    reactjs:
      "bg-cyan-100 dark:bg-cyan-500/20 text-cyan-700 dark:text-cyan-400 border-cyan-300 dark:border-cyan-400/30",
    framermotion:
      "bg-violet-100 dark:bg-violet-500/20 text-violet-700 dark:text-violet-400 border-violet-300 dark:border-violet-400/30",
    shadcnui:
      "bg-slate-100 dark:bg-slate-500/20 text-slate-700 dark:text-slate-400 border-slate-300 dark:border-slate-400/30",
    pytorch:
      "bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-400 border-orange-300 dark:border-orange-400/30",
    pytorchinprogress:
      "bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-400 border-orange-300 dark:border-orange-400/30",

    // AI & ML Tools
    langchain:
      "bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-400 border-purple-300 dark:border-purple-400/30",
    huggingface:
      "bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-400/30",
    gemini:
      "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 border-blue-300 dark:border-blue-400/30",
    ...
    github:
      "bg-gray-100 dark:bg-gray-700/20 text-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-300/30",
    cicdpipelines:
      "bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 border-green-300 dark:border-green-400/30",
    ...
    uiuxdesign:
      "bg-pink-100 dark:bg-pink-500/20 text-pink-700 dark:text-pink-400 border-pink-300 dark:border-pink-400/30",
    responsivedesign:
      "bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 border-emerald-300 dark:border-emerald-400/30",
    designsystems:
      "bg-slate-100 dark:bg-slate-500/20 text-slate-700 dark:text-slate-400 border-slate-300 dark:border-slate-400/30",
    ...
    chromeextensions:
      "bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-400/30",
    manifestv3:
      "bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 border-amber-300 dark:border-amber-400/30",
  };
  ...
  return (
    colorMap[techLower] || "bg-muted/50 text-muted-foreground border-border/50"
  ); // Default fallback
};

export const getTechIconComponent = (
  tech: string,
...
export const TECH_CATEGORIES = {
  ...
  Frontend: ["React", "Next.js", "TailwindCSS", "Framer Motion", "Vite"],
  Backend: ["Node.js", "FastAPI", "Supabase", "Postgres"],
  "AI / ML": ["Gemini", "LangChain", "OpenAI API", "Tavily"],
  Tools: ["Docker", "Git", "Vercel", "Chrome Extension"],
};
