...
const TECH_ICONS = {
    ...
    'VS Code': (props: React.SVGProps<SVGSVGElement>) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
// Tech stack data organized by categories with better light/dark mode colors
const TECH_STACK = {
    languages: [
        {
            name: 'Java',
            icon: TECH_ICONS.Java,
        ...
        },
        {
            ...
            color: 'bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-400/30'
        },
        {
            name: 'TypeScript',
            icon: TECH_ICONS.TypeScript,
            color: 'bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-300/30'
        },
        {
            name: 'HTML5',
            icon: TECH_ICONS.HTML5,
            color: 'bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 border-red-300 dark:border-red-400/30'
        },
        {
            name: 'CSS3',
            icon: TECH_ICONS.CSS3,
            color: 'bg-blue-100 dark:bg-blue-400/20 text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-300/30'
        },
    ],
    frameworks: [
        {
            name: 'Next.js',
            icon: TECH_ICONS['Next.js'],
            color: 'bg-gray-100 dark:bg-gray-800/20 text-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-300/30'
        },
        {
            name: 'Node.js',
            icon: TECH_ICONS['Node.js'],
            color: 'bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 border-green-300 dark:border-green-400/30'
        },
        {
            name: 'FastAPI',
            icon: TECH_ICONS.FastAPI,
            color: 'bg-teal-100 dark:bg-teal-500/20 text-teal-700 dark:text-teal-400 border-teal-300 dark:border-teal-400/30'
        },
        {
            name: 'TailwindCSS',
            icon: TECH_ICONS.TailwindCSS,
        ...
        },
        {
            ...
            color: 'bg-pink-100 dark:bg-pink-500/20 text-pink-700 dark:text-pink-400 border-pink-300 dark:border-pink-400/30'
        },
        {
            name: 'Git',
            icon: TECH_ICONS.Git,
            color: 'bg-orange-100 dark:bg-orange-600/20 text-orange-700 dark:text-orange-400 border-orange-300 dark:border-orange-400/30'
        },
        {
            name: 'GitHub',
        ...
        {
            name: 'VS Code',
            icon: TECH_ICONS['VS Code'],
            color: 'bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-400 border-blue-300 dark:border-blue-400/30'
        },
    ],
};
        ...
        <section className="py-16">
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {TECH_STACK.languages.map((tech) => {
                                ...
                                return (
                                    <div
                                        key={tech.name}
                                        className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-full border ${tech.color} transition-all duration-200 hover:scale-105`}
                                    >
                    ...
                    <div className="text-center">
                        <h3 className="text-xl font-semibold text-foreground mb-6">
                            <span className="text-muted-foreground">Frameworks & Tools</span>
                        </h3>
                        <div className="flex flex-wrap justify-center gap-3">
