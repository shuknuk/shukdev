...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    caseStudy: {
      ...
      solution: 'I spearheaded the design and development of the full website using Next.js, TailwindCSS, and Framer Motion. To move fast without sacrificing quality, I tapped into AI tools like <strong>ChatGPT</strong> to generate layout suggestions, debug tricky logic, and bootstrap components—while using <strong>Copilot</strong> to autocomplete repetitive CSS and JSON‑powered content sections. This hybrid workflow let me maintain control over the final look and logic, while cutting manual grunt work. The site was continuously deployed on <strong>Vercel</strong>, making updates seamless and reliable.',
